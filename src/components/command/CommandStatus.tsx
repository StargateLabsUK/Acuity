    ...
    <div className="flex flex-col bg-card">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-0">
        ...
        <div className="px-3 py-2.5 md:px-4 md:py-3 border-r border-b md:border-b-0 border-border">
          ...
          <div className="font-heading text-3xl md:text-5xl text-foreground font-bold leading-none mb-2">
            {todayReports.length}
          </div>
          <div className="flex flex-col gap-0.5">
            <div className="flex items-center justify-between">
              <span className="text-lg md:text-lg" style={{ color: '#FF3B30' }}>P1</span>
              <span className="font-heading text-2xl md:text-3xl font-bold" style={{ color: '#FF3B30' }}>{priorityCounts.P1}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-lg md:text-lg" style={{ color: '#FF9500' }}>P2</span>
              <span className="font-heading text-2xl md:text-3xl font-bold" style={{ color: '#FF9500' }}>{priorityCounts.P2}</span>
            </div>
            <div className="flex items-center justify-between">
