      ...
      >
        <div className="flex flex-wrap items-start justify-between gap-1.5">
          ...
          <div className="text-right">
            <div className="text-lg md:text-lg text-foreground">{dateStr} {timeStr}</div>
          </div>
        </div>
      </div>
