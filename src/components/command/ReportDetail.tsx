...
CREW NOTES: Generated by Herald Radio Intelligence`;
  ...
  return (
    <div className="h-full overflow-y-auto p-2.5 md:p-4 flex flex-col gap-3 md:gap-6 min-w-0" style={{ scrollbarWidth: 'thin' }}>
      {/* Priority Banner */}
      <div
      ...
      >
        <div className="flex flex-wrap items-center justify-between gap-1.5">
          ...
          <div className="text-right">
            <div className="text-xs md:text-xl text-foreground uppercase font-bold">{service}</div>
            <div className="text-[10px] md:text-lg text-foreground mt-0.5">{dateStr} {timeStr}</div>
          </div>
        </div>
      </div>
      ...
      {/* Headline */}
      <DetailCard>
        <p className="text-sm md:text-xl text-foreground leading-relaxed font-medium break-words">{headline}</p>
      </DetailCard>
      ...
      <div>
        ...
        <DetailCard>
          <p className="text-xs md:text-lg text-foreground leading-5 md:leading-7 italic break-words">
            &ldquo;{report.transcript ?? 'N/A'}&rdquo;
          </p>
          <div className="text-[10px] md:text-lg text-foreground mt-1.5 md:mt-3 opacity-70">
          ...
          <DetailCard>
            <div className="flex flex-col gap-2.5 md:gap-4">
              {Object.entries(structured).map(([k, v]) => (
                <div key={k}>
                  <div className="text-xs md:text-lg font-bold tracking-wide mb-0.5" style={{ color: col }}>{k}</div>
                  <div className="text-xs md:text-lg text-foreground leading-relaxed break-words">{v ?? '—'}</div>
                </div>
              ))}
