...
CREW NOTES: Generated by Herald Radio Intelligence`;
  ...
  return (
    <div className="h-full overflow-y-auto p-3 md:p-5 flex flex-col gap-4 md:gap-6 min-w-0" style={{ scrollbarWidth: 'thin' }}>
      {/* Priority Banner */}
      <div
      ...
      <div>
        ...
        <DetailCard>
          <div className="text-xs md:text-lg text-foreground leading-5 md:leading-8 whitespace-pre-wrap break-words">
      ...
      <div>
        ...
        <DetailCard>
          <div className="text-xs md:text-lg text-foreground leading-5 md:leading-7 whitespace-pre-wrap break-words">
            {eprfText}
          </div>
        </DetailCard>
      </div>
